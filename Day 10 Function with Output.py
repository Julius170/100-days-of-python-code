...
# DOCSRTINGS: ARE WAYS TO CREATE DOCUMENTATIONS FOR OUR CODES 
# EXAMPLES: lines 5 & 6
...
def calculator():         # RECURSION
    ...
    while should_continue:
        ...
        if  input(f"Type 'y' to continue claculating with {answer} or type 'n' to start a new calculator :") == 'y':
            num1 = answer
        else:
