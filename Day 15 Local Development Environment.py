...
# COULDN'T COMPLETE TODAY'S PROJECT ON MY OWN
# your_order = input("what do you want: ")
# for items in MENU:
#     order_water = ["water"]
#     order_milk = your_order["milk"]
#     order_coffee = your_order["coffee"]
#     print(order_water)
#     print(order_milk)
#     print(order_coffee)
# if your_order != "cappuccino" or your_order != "espresso" or your_order != "latte":
#     print("Invalid Input")
#
